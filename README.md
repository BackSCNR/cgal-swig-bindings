...
This binding includes optional support for point cloud registration using:

- **OpenGR** (Super4PCS) - Global registration for unknown initial alignment
- **libpointmatcher** (ICP) - Iterative Closest Point for fine registration

The registration functions are available in the `CGAL_Point_set_processing_3` module:

- `register_point_sets_opengr()` - Coarse global alignment
- `register_point_sets_pointmatcher()` - Fine ICP refinement
